...
private _assignmentControls = [
    RACA_IDC_PAGE_PREV, RACA_IDC_PAGE_NEXT, RACA_IDC_PAGE_LABEL, RACA_IDC_CLEAR_MAGAZINES, RACA_IDC_CLEAR_MISSING_FILTERS,
    ...
    RACA_IDC_LIMIT_RESET,
    RACA_IDC_LIMIT_VALUE_LABEL,
