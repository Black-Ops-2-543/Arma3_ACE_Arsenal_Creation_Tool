...
private _index = createHashMapFromArray [["generation",_generation],["count",count _catalog],["class",_byClass],["category",_categories],["source",_sources],["addon",_addons],["author",_authors],["all",_all],["sorts",createHashMap]];
